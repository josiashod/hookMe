...
module.exports = {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Here is the server's url used for sending confirmation link to the user
  |
  */

  clientUrl: Env.get('CLIENT_URL', 'http://localhost:3333/api'),
  ...
  |--------------------------------------------------------------------------
  |
  | Here we define expire token time
  |
  */

  confirmationTokenTimeOut: Env.get('CONFIRMATION_TOKEN_TIME_OUT', 7200),
}
